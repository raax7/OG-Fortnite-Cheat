...
void SDKInitializer::WalkVFT(const char* TargetFunctionName, void** VFT, const void* TargetFunction, uintptr_t& VFTIndex, const int SearchRange)
{
...
void SDKInitializer::InitVFTIndex(const char* VFTName, std::vector<const char*> PossibleSigs, const wchar_t* SearchString, uintptr_t& VFTIndex, const int SearchRange, const int SearchBytesBehind)
{
...
void SDKInitializer::InitFunctionOffset(const char* FunctionName, std::vector<const char*> PossibleSigs, const wchar_t* SearchString, uintptr_t& FunctionOffset, const int SearchRange, const int SearchBytesBehind)
{
...
void SDKInitializer::InitFunctionOffset(const char* FunctionName, std::vector<const char*> PossibleSigs, const char* SearchString, uintptr_t& FunctionOffset, const int SearchRange, const int SearchBytesBehind)
{
    DEBUG_LOG(LOG_INFO, std::string(skCrypt("Searching for ")) + std::string(FunctionName) + std::string(skCrypt(" function offset")));

    ...
    if (MenuOpen)
    {
        ...
        case 2:
        {
            ...
            case 5:
            {
                ...
                {
                    SDK::Cast<SDK::AFortPlayerController>(SDK::GetLocalController())->ServerAttemptInteract(SDK::GetLocalController(), SDK::Cast<SDK::UPrimitiveComponent, true>(SDK::GetLocalController()->BlueprintCreatedComponents()->GetByIndex(0)), SDK::ETInteractionType::IT_Simple, nullptr);
                }
            }
            break;
            }

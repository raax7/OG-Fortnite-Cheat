...
#define noinfo_assert(expression) (void)(                                                       \
            (!!(expression)) ||                                                              \
            (_wassert(_CRT_WIDE(#expression), _CRT_WIDE(""), (unsigned)(0)), 0) \
        )

#define IM_ASSERT(_EXPR)            noinfo_assert(_EXPR)                        // You can override the default assert handler by editing imconfig.h
#endif
